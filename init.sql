-- =====================================================
-- MICRO ERP - Sistema de Gestión Completo v2.0
-- Base de Datos MySQL
-- =====================================================
...
('Tecnología', 'Equipos y dispositivos tecnológicos', '#3b82f6'),
('Electrónica', 'Componentes y accesorios electrónicos', '#10b981'),
('Oficina', 'Suministros de oficina', '#f59e0b'),
('Redes', 'Equipos de red y conectividad', '#8b5cf6'),
('Accesorios', 'Accesorios diversos', '#ec4899');
...
INSERT INTO suppliers (name, company_name, rfc_tax_id, contact_name, email, phone, city, payment_terms) VALUES
('Tech Solutions SA', 'Tech Solutions SA de CV', 'TSO20190123', 'María García', 'ventas@techsolutions.com', '55-1234-5678', 'Ciudad de México', '30 días'),
('Electrónica del Norte', 'Electrónica del Norte S.A.', 'ELN20180515', 'Roberto Hernández', 'contacto@electronorte.com', '81-2345-6789', 'Monterrey', 'contado'),
('Suministros Express', 'Suministros Express', 'SUP20200101', 'Ana López', 'compras@suminexpress.com', '33-3456-7890', 'Guadalajara', '15 días');

-- 8. Supplier Products (Price Lists)
...
-- 9. Provider Orders (Enhanced)
CREATE TABLE IF NOT EXISTS provider_orders (
    id INT AUTO_INCREMENT PRIMARY KEY,
    order_number VARCHAR(50) UNIQUE,
    supplier_id INT NOT NULL,
    status ENUM('draft', 'pending', 'sent', 'confirmed', 'in_transit', 'received', 'partial', 'completed', 'cancelled') DEFAULT 'draft',
...
-- 11. Computer Stations (Cibercontrol)
...
-- 12. Internet Sessions (Cibercontrol)
...
('Impresión B/N', 'Impresión tamaño carta B/N', 'impresion', 1.00, 5),
('Impresión Color', 'Impresión tamaño carta color', 'impresion', 5.00, 10),
...
CREATE TABLE IF NOT EXISTS equipment (
    ...
    status ENUM('available', 'in_use', 'maintenance', 'cleaning', 'retired') DEFAULT 'available',
